...
Now that Lab 5 has been explained, lets quickly update our Nornir host file and uncomment out a few new attributes that will render new configurations to accomplish the goals explained previously!

1. Navigate to the `host.yml` file via `ac2_cicd_workshop/inventory/` directory.
...
2. Show pipeline success for all stages.
